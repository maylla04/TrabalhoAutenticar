...
export default async function ListUsers({lista}) {
    ...
    return(
        <div className="grid p-20">
                ...
                <div className="grid grid-cols-3 p-4 bg-amber-200" key={index}>
                    <p className="border-amber-300 p-3 text-white bg-amber-300">{lista.name}</p>
                    <p className="border-amber-300 p-3 text-white bg-amber-300">{lista.email}</p>
                    <div className="p-3">
